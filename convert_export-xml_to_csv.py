#!/usr/bin/env python3
# All credit due to simonkrenger, from his github: https://github.com/simonkrenger/apple-health-to-fitbit/blob/master/convert_export-xml_to_csv.pyand : 
import xml.etree.ElementTree as ET

print("Start parse.")

export = ET.parse('export_Phillip.xml')
